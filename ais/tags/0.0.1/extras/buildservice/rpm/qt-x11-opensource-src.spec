#
# spec file for package ais-qt-devel (Version 4.4.x)
#
...
%clean -n ais-qt-devel
rm -rf %buildroot

%post -n ais-qt-devel
/sbin/ldconfig

%postun -n ais-qt-devel
/sbin/ldconfig

%files -n ais-qt-devel
%defattr(-,root,root)
/usr/bin/*
%_libdir/*.*
%_libdir/pkgconfig/*

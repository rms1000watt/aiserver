...
{
    cpCloseAct = new QAction(QIcon(":/images/document-close.png"), tr("Close"), this);
    ...
    cpNewAct = new QAction(QIcon(":/images/document-new.png"), tr("New"), this);
    ...
    cpOpenAct = new QAction(QIcon(":/images/document-open.png"), tr("Open..."), this);
	...
	{	switch (iReqType)
		...
		{	// Modified. Reset modified flag.
			...
			{	// Refresh. Force a refresh of agent names in node tab.
				setEnabled(true);
				apPage->editSetModified(false);		// Generates a textModified signal

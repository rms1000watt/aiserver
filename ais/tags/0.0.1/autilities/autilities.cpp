...
-# XML format:
\verbatim
 </amp  act="MyAct" status="0" target="MyTarget" context="MyContext" mode="async"><Arg>...</Arg></amp>
\endverbatim
 */
bool AUtil::xmlToAmpmsg(const QString& irXml,QString& orAmpmsg,QString& orAct,QString& orContext,QString& orMode,QString& orTarget)
{
	...
	// Extract the name and attributes from the root element: act, context, mode, target

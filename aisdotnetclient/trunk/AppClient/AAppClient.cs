...
namespace AppClient
{
    ...
    public class AAppClient
    {
        ...
        public AAppClient(string irHostDnsIp, ushort iPort,
                   AReturnReceiver iReceiver, string irName)
        {
        ...
        public AXID AddUser(AReturnReceiver iReceiver, string irUsername,
        ...
        public AXID CloseCabinet(AReturnReceiver iReceiver, string iCabName)
        {
            AXID aXid = 0;
        ...
        public AXID CloseConnection(AReturnReceiver iReceiver, int iConnectId, ACloseMode iMode)
        {
        ...
        /// <param name="iMode">Close mode.</param>
        /// <returns>Request id.</returns>
        public AXID CloseContext(AReturnReceiver iReceiver, string iContextName, int iMode)
        {
            AXID aXid = 0;
            int aStatus = 0;
        ...
        /// <param name="iMode">Close mode.</param>
        /// <returns>Request id.</returns>
        public AXID CloseSession(AReturnReceiver iReceiver, int iSessionId, int iMode)
        {
            AXID aXid = 0;
            int aStatus = 0;
        ...
        public AXID CompileAgent(AReturnReceiver iReceiver, string[] iExtentAgentList)
        {
            AXID aXid = 0;
        ...
        /// <returns>Request id.</returns>
        public AXID CompileCabinet(AReturnReceiver iReceiver, string[] iExtentNames)
        {
            AXID aXid = 0;
        ...
        /// <param name="iSessionId">Session id.</param>
        /// <returns>Request id.</returns>
        public AXID ConnectSession(AReturnReceiver iReceiver, int iSessionId)
        {
            int aXid = 0;
            int aStatus = 0;
        ...
        /// <returns>Request id.</returns>
        public AXID Debug(AReturnReceiver iReceiver, string iExp)
        {
        ...
        /// <returns>Request id.</returns>
        public AXID DeleteUser(AReturnReceiver iReceiver, int iUserId)
        {
        ...
        /// <returns>Request id.</returns>
        public AXID EnableConsoleLog(AReturnReceiver iReceiver, int iEnable)
        {
        ...
        /// <returns></returns>
        public AXID EraseNode(AReturnReceiver iReceiver, string[] iAgentList)
        {
            AXID aXid = 0;
        ...
        /// <returns></returns>
        public AXID Eval(AReturnReceiver iReceiver, string iExp, byte[] iData, int iDataSize)
        {
        ...
        /// <param name="iDataSize"></param>
        /// <returns></returns>
        public AXID Execute(AReturnReceiver iReceiver, string iExp, byte[] iData, int iDataSize)
        {
        ...
        /// <returns></returns>
        public AXID ExportCabinetRemote(AReturnReceiver iReceiver, string iCabName, string iCabPath)
        {
            AXID aXid = 0;
        ...
        /// <returns></returns>
        public AXID ExportNodeRemote(AReturnReceiver iReceiver, string iCabName, string iNodeName, string iFilePath)
        {
            AXID aXid = 0;
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetConnectionStats(AReturnReceiver iReceiver)
        {
        ...
        /// <returns></returns>
        public AXID GetConsoleLog(AReturnReceiver iReceiver, bool iClear)
        {
        ...
        /// <returns></returns>
        public AXID GetContextParams(AReturnReceiver iReceiver, string iContextName)
        {
            AXID aXid = 0;
            int aStatus = 0;
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetCurrentContexts(AReturnReceiver iReceiver)
        {
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetExeSession(AReturnReceiver iReceiver)
        {
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetExtentNames(AReturnReceiver iReceiver)
        {
        ...
        /// <returns></returns>
        public AXID GetExtentTypes(AReturnReceiver iReceiver, bool iForce)
        {
            AXID aXid = 0;
        ...
        /// <returns></returns>
        public AXID GetDirInfo(AReturnReceiver iReceiver, string iDir)
        {
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetLogonStats(AReturnReceiver iReceiver)
        {
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetNextLevel(AReturnReceiver iReceiver)
        {
            AXID aXid = 0;
        ...
        /// <returns></returns>
        public AXID GetNextLevel(AReturnReceiver iReceiver, string iFullNodeName)
        {
            AXID aXid = 0;
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetPreviousLevel(AReturnReceiver iReceiver)
        {
            AXID aXid = 0;
            string aAmpMsg = string.Empty;
            AExtentInfo aInfo = null;
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetRootLevel(AReturnReceiver iReceiver)
        {
            AXID aXid = 0;
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetRequestStats(AReturnReceiver iReceiver)
        {
        ...
        /// <param name="iContextName"></param>
        /// <returns></returns>
        public AXID GetSessions(AReturnReceiver iReceiver, string iContextName)
        {
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetSessionStats(AReturnReceiver iReceiver)
        {
        ...
        /// <param name="iContextName"></param>
        /// <returns></returns>
        public AXID GetSubscriptions(AReturnReceiver iReceiver, string iContextName)
        {
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetUsers(AReturnReceiver iReceiver)
        {
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID GetWorkspaceStatistics(AReturnReceiver iReceiver)
        {
        ...
        /// <param name="iFilePath"></param>
        /// <returns></returns>
        public AXID ImportCabinetRemote(AReturnReceiver iReceiver, string iCabName, string iFilePath)
        {
            AXID aXid = 0;
        ...
        /// <param name="iContextName"></param>
        /// <returns></returns>
        public AXID IsContextOpen(AReturnReceiver iReceiver, string iContextName)
        {
            AXID aXid = 0;
        ...
        /// <param name="iReceiver"></param>
        /// <returns></returns>
        public AXID Logoff(AReturnReceiver iReceiver)
        {
        ...
        /// <returns></returns>
        public AXID Logon(AReturnReceiver iReceiver, string iUsername, string iPassword)
        {
        ...
        /// <returns>Request id.</returns>
        public AXID NewCabinet(AReturnReceiver iReceiver, string iCabName, string iCabPath)
        {
            AXID aXid = 0;
            int aStatus = 0;
        ...
        /// <param name="iCabPath">Cabinet path.</param>
        /// <returns>Request id.</returns>
        public AXID OpenCabinet(AReturnReceiver iReceiver, string iCabName, string iCabPath)
        {
            AXID aXid = 0;
            int aStatus = 0;
        ...
        /// <param name="iReceiver">Response handler.</param>
        /// <returns>Request id.</returns>
        public AXID OpenConnection(AReturnReceiver iReceiver)
        {
            AXID aXid = 0;
            int aStatus = 0;
            int aPendingReq = 0;
        ...
        /// <returns>Request id.</returns>
        public AXID OpenConsoleLog(AReturnReceiver iReceiver, bool iClear, 
        ...
        /// <param name="iContextName">Context name.</param>
        /// <returns>Request id.</returns>
        public AXID OpenContext(AReturnReceiver iReceiver, string iStartupPath, string iContextName)
        {
        ...
        /// <returns>Request id.</returns>
        public AXID OpenNode(AReturnReceiver iReceiver, string iExtentName, string iFullNodeName)
        {
            AXID aXid = 0;
            int aStatus = 0;
        ...
        /// <param name="iContextName">Context name.</param>
        /// <returns>Request id.</returns>
        public AXID OpenSession(AReturnReceiver iReceiver, string iContextName)
        {
            AXID aXid = 0;
            int aStatus = 0;
        ...
        /// <param name="iReceiver">Response handler.</param>
        /// <returns>Request id.</returns>
        public AXID RefreshLevel(AReturnReceiver iReceiver)
        {
            AXID aXid = 0;
            string aAmpMsg = string.Empty;
        ...
        /// <param name="iStartupPath">Start-up path.</param>
        /// <returns>Request id.</returns>
        public AXID RegisterContext(AReturnReceiver iReceiver, string iStartupPath)
        {
            ...
            string iError, string iClientData, bool iClearReqQueueItem)
        {
            ...
            AReturnReceiver aReceiver = _DefaultReceiver;
            string aOut = iAisOut;
            ...
            else if (iStatus > 0)
            {
                ...
                while (aEnum.MoveNext())
                {
                    ...
                    if (aReq.Receiver == null)
                    {
                        ...
                        aTmpStatus = (int)AErrorCodes.NoClient;
                    }
                    else
                    {
                        aReceiver = aReq.Receiver;
                    ...
                    aReceiver.ReturnOutput(this, _ConnectionId, aXid, aTmpStatus, 
                        iReqType, iRetValue, aOut, iData, iDisplay, iError, aReq.ClientData);
            ...
            else
            {
                ...
                switch (iReqType)
                {
                    ...
                    case ARequestType.LogUserAccess:
                        ...
                        {
                            _LogReceiver.ReturnOutput(this, 0, 0, 0, iReqType, 0, aOut, null, null, null, null);
                        }
                        break;
                    default:
                        // emit response event
                        if (aReceiver != null)
                        {
                            aReceiver.ReturnOutput(this, _ConnectionId, iXid, 
                                iStatus, iReqType, iRetValue, aOut, iData, iDisplay, iError, iClientData);
                        }
                        break;
                }
            }
        ...
        /// <returns>Request id.</returns>
        public AXID RunRemoteScriptFile(AReturnReceiver iReceiver, string iFilePath, string iPrefix)
        {
            AXID aXid = 0;
        ...
        /// <returns>Request id.</returns>
        public AXID SaveNode(AReturnReceiver iReceiver, string iExtentName,
        ...
        /// <returns>Request id.</returns>
        public AXID SetBreakPoint(AReturnReceiver iReceiver, string iAgentName)
        {
            AXID aXid = 0;
        ...
        /// <returns>Request id.</returns>
        public AXID SetEngineFlags(AReturnReceiver iReceiver, uint iFlags)
        {
        ...
        /// <returns>Request id.</returns>
        public AXID SetErrorTrace(AReturnReceiver iReceiver, bool iOnOff)
        {
        ...
        /// <param name="iSessionId">Session id.</param>
        /// <returns>Request id.</returns>
        public AXID SetEscape(AReturnReceiver iReceiver, int iSessionId)
        {
            AXID aXid = 0;
            if (iSessionId == 0)
                iSessionId = _SessionId;
        ...
        /// <returns>Request id.</returns>
        public AXID SetInstructionTrace(AReturnReceiver iReceiver, bool iOnOff)
        {
        ...
        /// <param name="iOnOff">Switch flag.</param>
        /// <returns>Request id.</returns>
        public AXID SetJit(AReturnReceiver iReceiver, bool iOnOff)
        {
        ...
        /// <returns>Request id.</returns>
        public AXID SetLogLevel(AReturnReceiver iReceiver, ARequestType iLogType,
        ...
        /// </summary>
        /// <param name="iReceiver">Response handler.</param>
        public void SetLogReceiver(AReturnReceiver iReceiver)
        {
            _LogReceiver = iReceiver;
        }
        ...
        /// <returns>Request id.</returns>
        public AXID SetRules(AReturnReceiver iReceiver, string iRules, bool iRemove)
        {
        ...
        /// <returns>Request id.</returns>
        public AXID SetSubscriptions(AReturnReceiver iReceiver, string iNewSessions,
            string iOldSessions)
        {
        ...
        /// <param name="iOnOff">Switch flag.</param>
        /// <returns>Request id.</returns>
        public AXID SetSysCheck(AReturnReceiver iReceiver, bool iOnOff)
        {
        ...
        /// <returns>Request id.</returns>
        public AXID ShowConsoleSelection(AReturnReceiver iReceiver, string iText)
        {
            AXID aXid = 0;
        ...
        /// <returns>Request id.</returns>
        public AXID Submit(AReturnReceiver iReceiver, ref string irAmpMsg)
        {
        ...
        /// <param name="irAmpMsg">AMP message.</param>
        /// <returns>Request id.</returns>
        private AXID SubmitError(AReturnReceiver iReceiver, int iStatus, ARequestType iReqType,
            ref string irAmpMsg)
        {
        ...
        /// <returns>Request id.</returns>
        public AXID UpdateUser(AReturnReceiver iReceiver, int iUserId, string iUsername,
        ...
        private void ProcessGetNextLevel(ref string iOut)
        {
            ...
            foreach (string aLine in aLines)
            {
                ...
                {
                    ANodeInfo aNodeInfo = new ANodeInfo(aField[0],
                        aField[1], aField[2], aField[3], aField[4], aField[5],
                        aField[6], aField[7]);
        ...
        public AReturnReceiver DefaultReceiver
        {
        ...
        private AReturnReceiver _LogReceiver;

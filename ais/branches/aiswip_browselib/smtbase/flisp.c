...
/* Are we generating debuging information for this Lambda? */
...
while( hNdx < hLen  )
    ...
    switch ((curChar = atHMChar(hSrc,hNdx++)))
        ...
        case ']':
            ...
            /*  No other action is associated with exitting a compound variable reference. */
        ...
        case '}':
            ...
            /*  Get information required for postprocessing this node, certain cases require */
            /*  further analysis. */

...
win32 {
	...
	# try 1st location
	MYSQL_LANG_DIR = "C:\MySQL\share\english"
	...
	exists($$MYSQL_LANG_FILE) {
		...
		# try 2nd location
		MYSQL_LANG_DIR = "C:\Program Files (x86)\MySQL\MySQL Server 5.5\share\english"
		MYSQL_LANG_FILE = "$$MYSQL_LANG_DIR\errmsg.sys"
		...
		exists($$MYSQL_LANG_FILE) {
			...
			# try 3rd location
			MYSQL_LANG_DIR = "C:\Program Files\MySQL\MySQL Server 5.5\share\english"
			MYSQL_LANG_FILE = "$$MYSQL_LANG_DIR\errmsg.sys"
			exists($$MYSQL_LANG_FILE) {
				# copy it
				message("copying from $$MYSQL_LANG_FILE .")

...
gCP->FCompile_adduSym = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"addu");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_adduSym,TRUE);
gCP->FCompile_iaddSym  = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"iadd");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_iaddSym,TRUE);
gCP->FCompile_uaddSym  = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"uadd");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_uaddSym,TRUE);
gCP->FCompile_idivSym  = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"idiv");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_idivSym,TRUE);
gCP->FCompile_udivSym  = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"udiv");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_udivSym,TRUE);
gCP->FCompile_imodSym  = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"imod");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_imodSym,TRUE);
gCP->FCompile_umodSym  = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"umod");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_umodSym,TRUE);
gCP->FCompile_imulSym = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"imul");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_imulSym,TRUE);
gCP->FCompile_umulSym = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"umul");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_umulSym,TRUE);
gCP->FCompile_isubSym = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"isub");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_isubSym,TRUE);
gCP->FCompile_usubSym = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"usub");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_usubSym,TRUE);
...
gCP->FCompile_divuSym = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"divu");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_divuSym,TRUE);
...
gCP->FCompile_divruSym = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"modu");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_divruSym,TRUE);
...
gCP->FCompile_muluSym  = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"mulu");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_muluSym,TRUE);
...
gCP->FCompile_subuSym = TSymbol_MakeUnique(gCP,gTP,(LpCHAR)"subu");
FObject_Perm(gCP,gTP,(TObject*)gCP->FCompile_subuSym,TRUE);
...
switch (tag)
	...
	case TYNUM: 
		...
		ret->Offset = envIndex;
		ret->u.Int = (envIndex * AISWORDARRAYITEMSIZE);
		break;
	...
	if (original[mod].Modifier == AMREGISTER)
		...
		if (atHMBind(rVars->itsDictionaryArray,envIndex).Value.DeclaredType == TYREAL)
			...
			*tmp = FSpecialForms1_AllocTemp(gCP,gTP,compilerState,TYVOID);
			...
			temp[mod].u.Int = (temp[mod].Offset << BITSIZEOFAISWORD);
...
if (strncmp(objSymbolArray(theSymbol),"regoffset:",10) == 0)
	...
	*offset = FUtil2_Offset(gCP,gTP,prmc,prmv);
	...
	switch (ret->Modifier)
		...
		case AMREGISTER:
		case AMTVOFFSET:
			ret->Offset /= AISWORDARRAYITEMSIZE;
			break;
		}
...
switch (modifier)
	...
	default:
		...
		if (type.Tag == TYQUOTEDSYMBOL)
			...
			else if (strcmp(SymbolArray(type),"UInteger") == 0) ret->DeclaredType = TYUNUM;
			...
			if ((ret->DeclaredType == TYUNUM) && (ret->Tag != TYUNUM))
				{
				ret->u.Int = 0;
				ret->Tag = TYUNUM;
				}

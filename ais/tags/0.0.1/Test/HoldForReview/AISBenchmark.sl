...
;;
;;  Project:  The speed of simple AIS Lisp Lambda execution
...
(writeln "AIS Benchmark Test started") 
...
(define (lispSourceFile K)
    ...
    (loop for i from 0 until k do 
       (setq X (readSourceFile "AISBenchmark.sl"))
       (writeSourceFile "AISBenchmark.txt" X)
       )
    k)

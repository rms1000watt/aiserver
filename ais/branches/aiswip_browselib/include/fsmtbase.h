...
#ifdef _M64
#define CURRENT_VERSION		"5.0011-64bit"
#else
#define CURRENT_VERSION		"5.0011-32bit"
#endif
...
#define     asNumIndex(a)   ((a)->Tag==TYREAL?(a)->u.Real:(a)->Tag==TYNUM?(a)->u.Int:(a)->Tag==TYSHORT?(a)->u.Short:(a)->Tag==TYCHAR?((unsigned char)(a)->u.Char):(a)->Tag==TYMONEY?(a)->u.Real:(a)->Tag==TYDATE?(a)->u.Real:(a)->Tag==TYCPX?(a)->u.Complex->itsReal:0)
#define     isNumIndex(a)   ((asTag(a)==TYREAL) || (asTag(a)==TYNUM) || (asTag(a)==TYSHORT) || (asTag(a)==TYCHAR) || (asTag(a)==TYCPX))
...
typedef struct {TVAL*				TvalStack;									/* Smartbase operations stack */
				...
				TVAL				DebugBreakExp;								/* Current breakpoint is set with this until expression (or Void) */
...
#define TYCHARPOINTER	19
#define TYFLOAT         20
#define TYFLOATPOINTER	21
#define TYINTPOINTER	22
#define TYJUMPPOINTER	23
#define TYREALPOINTER	24
#define TYSHORTPOINTER	25
#define TYLONGPOINTER	26
#define TYWORDPOINTER	27
								...
								/* instructions */
#define TYBRICKFIELD	28
#define TYBRICKROW		29
#define TYSTRINGSUBSTR	30
#define TYMATRIXROW		31
#define TYNUMMATRIXROW  32
...
#define TYLAMBDA		34
#define TYBITVECTOR     35
#define TYBYTEVECTOR    36
#define TYCMACRO        37
#define TYCONTINUATION  38
#define TYCPX           39
#define TYCPROCEDURE    40
#define TYCPXVECTOR     41
#define TYDICTIONARY    42
#define TYDIRECTORY     43
#define TYERROR         44
#define TYFLTVECTOR     45
#define TYGLOBALS       46
#define TYINTVECTOR     47
#define TYLABELSYMBOL   48
#define TYLONGVECTOR	49
#define TYMACRO         50
#define TYMATRIX		51
#define TYNUMMATRIX		52
#define TYNUMVECTOR     53
#define TYOBJ           54
#define TYOBJREPOSITORY 55
#define TYOBJVECTOR     56
#define TYPAIR          57
#define TYQUOTEDPAIR    58
#define TYQUOTEDSYMBOL  59
#define TYBRICK			60
#define TYSHORTVECTOR	61
#define TYSPECIALFORM   62
#define TYSTRING        63
#define TYSTRUCTURE		64
#define TYSYMBOL        65
#define TYVECTOR	    66
#define TYVMEVALUATOR   67
#define TYWORKSPACE     68
#define TYPCODEVECTOR   69
#define TYMAXVALIDTYPE  69

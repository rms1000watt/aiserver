#
# spec file for package ais-static-xxx (Version x.x.x)
#
...
%if 0%{?suse_version}
BuildRequires: gcc-c++ ais-qt-static-devel ais-mysql-devel pwdutils update-desktop-files
%endif

%if 0%{?fedora_version}
BuildRequires: gcc-c++ libstdc++-devel ais-qt-static-devel ais-mysql-devel
%endif
...
%package -n ais-static-common
Summary:    AIS common files
Group:      Development/Languages/Other

%description -n ais-static-common
This package includes files needed by all AIS packages.

%package -n ais-static-service
Summary:    AIS service files
Requires:   ais-static-common
Group:      Development/Languages/Other

%description -n ais-static-service
This package includes the server binaries.

%package -n ais-static-ide
Summary:    AIS integrated development environment
Requires:   ais-static-common
Group:      Development/Languages/Other

%description -n ais-static-ide
This package includes the graphical client binaries.

%package -n ais-static-doc
Summary:    AIS documentation
Group:      Development/Languages/Other

%description -n ais-static-doc

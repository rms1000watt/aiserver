...
"hour,uadd,udiv,udivr,umul,usub,"
...
"memstat,methodsOf,"
"mid,minute,modulus,money,month,morph,muli,mulu,multiply,myself,"
...
"setLastCdr,setq,sin,sizeof,sort,sqrt,stringFill,sub1,subi,subu,subtract,super,"

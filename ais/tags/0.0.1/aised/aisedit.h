...
1.0107	 9/21/2006	tlw		Move onClose to doClose which returns false if cancel selected.
1.0107	 9/20/2006	tlw		Add cursor stack tool bar actions
...
private slots:
	...
	void		onCursorPositionChanged(long iRow, long iCol);

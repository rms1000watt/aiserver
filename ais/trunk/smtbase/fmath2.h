...
extern TVAL FMath2_Addu			(LpXCONTEXT gCP,LpTHREAD gTP,NUM argc,TVAL argv[]);
...
extern TVAL FMath2_Divu			(LpXCONTEXT gCP,LpTHREAD gTP,NUM argc,TVAL argv[]);
extern TVAL FMath2_Modi			(LpXCONTEXT gCP,LpTHREAD gTP,NUM argc,TVAL argv[]);
extern TVAL FMath2_Modu			(LpXCONTEXT gCP,LpTHREAD gTP,NUM argc,TVAL argv[]);
extern TVAL FMath2_Muli			(LpXCONTEXT gCP,LpTHREAD gTP,NUM argc,TVAL argv[]);
extern TVAL FMath2_Mulu			(LpXCONTEXT gCP,LpTHREAD gTP,NUM argc,TVAL argv[]);
extern TVAL FMath2_Subi			(LpXCONTEXT gCP,LpTHREAD gTP,NUM argc,TVAL argv[]);
extern TVAL FMath2_Subu			(LpXCONTEXT gCP,LpTHREAD gTP,NUM argc,TVAL argv[]);

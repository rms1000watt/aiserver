...
(defun porterStemmer(inputText)

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
;;   Summary:  The porterStemmer is a Lisp agent designed to
...
;;    ==================
;;   
;;    The child agent sequence gets the measure of a word. The measure of the word
...
vars: (ch cc i (ByteVector:result) )
 
regs:( (CharPointer:start)  (nill 0) (space 32) 
       (period 46)  (excpoint 33)  (question 63) (colon 58) (semicolon 59)
...
(if (= stemmedText #void) (setq stemmedText (new Vector:)))
...
(setq i 0)
(while (and (> (setq cc start[0]) space) (<> cc nill))
...
;;(writeln " word[(-- i)]: " word[(-- i)])
(setq puncVector #(int| period 58 59 33 63))
;; Punctuation Marks option
(if (isMember word[(-- i)] puncVector)
    (begin
        (writeln "here in isMember: " )
        (setq word[i] 0)
    ) ;; end begin
) ;; end if
...
(if (= traceLinesOn true)(writeln "porterStemmer: start: " start[0]))
(if (= htmlTagsOn false)
    (begin
...
End::
(if (= traceLinesOn true)(writeln "End of porterStemmer: " stemmedText))
(if (= traceLinesOn true)(writeln "End of porterStemmer: type: " (type stemmedText)))

stemmedText) ;; end porterStemmer
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;  Summary: This agent returns true on the 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Summary: This agent returns  the Boolean value true
...
;; 			 agent matches the suffix of the current 
;; 			 word evaluated
;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Summary: This agent gets the pointer to the
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Summary: This agent drops the old suffix

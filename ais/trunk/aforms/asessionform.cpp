	...
	cpEditPrefAct(0), cpReplaceDialog(NULL), cSessionId(0)
{
    ...
    //cpDataTab = new ADataPage(ipAppClient, this, this, "Data");
    //cpPages[SESSION_DATA] = cpDataTab;
    //addTab(cpDataTab, QString("Data"));

    //cpDataPreviewTab = new ADataPreviewPage(ipAppClient, this, this, "Preview");
    //cpPages[SESSION_PREVIEW] = cpDataPreviewTab;
    //addTab(cpDataPreviewTab, QString("Preview"));

    //cpModelTab = new AModelPage(ipAppClient, this, this, "Model");
    //cpPages[SESSION_MODEL] = cpModelTab;
    //addTab(cpModelTab, QString("Model"));

    //cpRunTab = new ARunPage(ipAppClient, this, this, "Run");
    //cpPages[SESSION_RUN] = cpRunTab;
    //addTab(cpRunTab, QString("Run"));

    //cpResultsTab = new AResultsPage(ipAppClient, this, this, "Results");
    //cpPages[SESSION_RESULTS] = cpResultsTab;
    //addTab(cpResultsTab, QString("Results"));
...
{
    cpCutAct = new QAction(QIcon(":/images/edit-cut.png"), tr("Cut"), this);
    ...
    cpCopyAct = new QAction(QIcon(":/images/edit-copy.png"), tr("Copy"), this);
    ...
    cpPasteAct = new QAction(QIcon(":/images/edit-paste.png"), tr("Paste"), this);
    ...
    cpFindAct = new QAction(QIcon(":/images/edit-find.png"), tr("Find..."), this);
    ...
    cpPrevAct = new QAction(QIcon(":/images/go-previous.png"), tr("Previous"), this);
    ...
    cpNextAct = new QAction(QIcon(":/images/go-next.png"), tr("Next"), this);
    ...
    cpPrintAct = new QAction(QIcon(":/images/document-print.png"), tr("Print"), this);
    ...
    cpUndoAct = new QAction(QIcon(":/images/edit-undo.png"), tr("Undo"), this);
    ...
    cpRedoAct = new QAction(QIcon(":/images/edit-redo.png"), tr("Redo"), this);
...
void ASessionForm::onCurrentTabChanged(int iTabIdx)
{
	...
	{	// New Page. If the edit window is empty, add a new empty page
        ...
        if (iTabIdx == SESSION_MODEL || iTabIdx == SESSION_PREVIEW || iTabIdx == SESSION_RESULTS)
        {
            cpPages[iTabIdx]->show();
        }
    ...
    char* ipData, long iDataSize, const QString& irDisplay, const QString& irError, const QString iClientData)
{
	...
	case geFcnSendStatusToClient:
		{
		cpRunTab->onStatusUpdateEvent(irOut);
		}
	break;
	...
	case geDisplay:
        if (cDemoRunMode)
            cpRunTab->display(irDisplay, irOut);
        else
...
ADataPage* ASessionForm::getDataPage()
{
    return cpDataTab;
}

AModelPage* ASessionForm::getModelPage()
{
    return cpModelTab;
}

ARunPage* ASessionForm::getRunPage()
{
    return cpRunTab;
}

void ASessionForm::setDemoRunMode(bool runmode)
{
    cDemoRunMode = runmode;
}

QString ASessionForm::getCommandPrefix()
{
	return cpConsoleTab->getCommandPrefix();
}

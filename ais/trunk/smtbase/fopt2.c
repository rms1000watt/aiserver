...
if (curPair->itsCar.Tag == TYQUOTEDSYMBOL)
	...
	else if (strcmp(SymbolArray(curPair->itsCar),"WordPointer") == 0) ret->u.Int = BITSIZEOFAISWORD;
...
switch (csPtr[2])
	...
	case 'a':
		...
		if (strcmp(csPtr,"vmaddu") == 0) {instruction = VMADDU;  goto MemoryThreeArgs;}
		else
	...
	case 'd':
		...
		if (strcmp(csPtr,"vmdivu") == 0) {instruction = VMDIVU; goto MemoryThreeArgs;}
		else
		...
		if (strcmp(csPtr,"vmdivru") == 0) {instruction = VMDIVRU; goto MemoryThreeArgs;}
		else
	...
	case 'm':
		...
		if (strcmp(csPtr,"vmmoveu") == 0) {instruction = VMMOVEU; goto MemoryTwoArgs;}
		else
		...
		if (strcmp(csPtr,"vmmulu") == 0) {instruction = VMMULU; goto MemoryThreeArgs;}
		else
	...
	case 'n':
		...
		if (strcmp(csPtr,"vmnatLoadUInteger") == 0) {instruction = vmnatLoadUInteger; goto MemoryTwoArgs;}
		else
		...
		if (strcmp(csPtr,"vmnatJmpEQUInteger") == 0) {instruction = vmnatJmpEQUInteger; goto MemoryJumpCC;}
		else
		if (strcmp(csPtr,"vmnatJmpLTUInteger") == 0) {instruction = vmnatJmpLTUInteger; goto MemoryJumpCC;}
		else
		if (strcmp(csPtr,"vmnatJmpGTUInteger") == 0) {instruction = vmnatJmpGTUInteger; goto MemoryJumpCC;}
		else
		if (strcmp(csPtr,"vmnatJmpNEUInteger") == 0) {instruction = vmnatJmpNEUInteger; goto MemoryJumpCC;}
		else
		if (strcmp(csPtr,"vmnatJmpGEUInteger") == 0) {instruction = vmnatJmpGEUInteger; goto MemoryJumpCC;}
		else
		if (strcmp(csPtr,"vmnatJmpLEUInteger") == 0) {instruction = vmnatJmpLEUInteger; goto MemoryJumpCC;}
		else
		...
		if (strncmp(csPtr,"vmreg",5) == 0) 
			...
			switch (csPtr[5])
				...
				case 'J':
					...
					if (strcmp(csPtr,"vmregJmpLTUImmediate") == 0) {instruction = vmregJmpLTUImmediate; goto RegisterImm_JumpCC;}
					else
					if (strcmp(csPtr,"vmregJmpLEUImmediate") == 0) {instruction = vmregJmpLEUImmediate; goto RegisterImm_JumpCC;}
					else
					if (strcmp(csPtr,"vmregJmpEQUImmediate") == 0) {instruction = vmregJmpEQUImmediate; goto RegisterImm_JumpCC;}
					else
					if (strcmp(csPtr,"vmregJmpNEUImmediate") == 0) {instruction = vmregJmpNEUImmediate; goto RegisterImm_JumpCC;}
					else
					if (strcmp(csPtr,"vmregJmpGEUImmediate") == 0) {instruction = vmregJmpGEUImmediate; goto RegisterImm_JumpCC;}
					else
					if (strcmp(csPtr,"vmregJmpGTUImmediate") == 0) {instruction = vmregJmpGTUImmediate; goto RegisterImm_JumpCC;}
					else
					...
					if (strcmp(csPtr,"vmregJmpLTUInteger") == 0) {instruction = vmregJmpLTUInteger; goto Register_JumpCC;}
					else
					if (strcmp(csPtr,"vmregJmpLEUInteger") == 0) {instruction = vmregJmpLEUInteger; goto Register_JumpCC;}
					else
					if (strcmp(csPtr,"vmregJmpEQUInteger") == 0) {instruction = vmregJmpEQUInteger; goto Register_JumpCC;}
					else
					if (strcmp(csPtr,"vmregJmpNEUInteger") == 0) {instruction = vmregJmpNEUInteger; goto Register_JumpCC;}
					else
					if (strcmp(csPtr,"vmregJmpGEUInteger") == 0) {instruction = vmregJmpGEUInteger; goto Register_JumpCC;}
					else
					if (strcmp(csPtr,"vmregJmpGTUInteger") == 0) {instruction = vmregJmpGTUInteger; goto Register_JumpCC;}
					else
				...
				case 'S':
					...
					if (strcmp(csPtr,"vmregSaveUInteger") == 0) {instruction = vmregSaveUInteger; goto Register_RegMemArgs;}
					else
	...
	case 's':
		...
		if (strcmp(csPtr,"vmsubu") == 0) {instruction = VMSUBU; goto MemoryThreeArgs;}
		else
	...
	case 'u':
		if (strcmp(csPtr,"vmuadd") == 0) {instruction = VMUADD; goto MemoryThreeArgs;}
		else
		if (strcmp(csPtr,"vmudiv") == 0) {instruction = VMUDIV; goto MemoryThreeArgs;}
		else
		if (strcmp(csPtr,"vmudivr") == 0) {instruction = VMUDIVR; goto MemoryThreeArgs;}
		else
		if (strcmp(csPtr,"vmumul") == 0) {instruction = VMUMUL; goto MemoryThreeArgs;}
		else
		if (strcmp(csPtr,"vmusub") == 0) {instruction = VMUSUB; goto MemoryThreeArgs;}
		else

...
private slots:
	...
	void	onRequestStarted(int iReqId);
...
private:
	enum APending {ceDone, ceAborting, ceClosing, ceDisconnecting, ceRequesting, ceSettingHost, ceSettingUser};
	void		abortTask();
	...
	const char*	cpErrMsgs[10];	// Error messages returned from QHttp
	...
	QString		cUrl;			// Complete request URL

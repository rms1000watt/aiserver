...
void ACabinetPage::createActions()
{
    ...
    cpNewCabinetAct = new QAction(QIcon(":/images/document-new.png"), tr("New Cabinet..."), this);
    ...
    cpOpenCabinetAct = new QAction(QIcon(":/images/document-open.png"), tr("Open Cabinet..."), this);
